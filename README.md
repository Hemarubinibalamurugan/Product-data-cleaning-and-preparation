...
* To standardize inconsistent text formats and correct typographical errors
* To identify and remove duplicate records
* To restructure dataset columns through splitting and merging operations
...
* Checked missing values in the Price column
* Replaced missing price values using suitable methods such as average values
...
* Standardized inconsistent text formats in the Product Name column
...
* Formatting and transformation techniques applied
* Conditional formatting rules created
